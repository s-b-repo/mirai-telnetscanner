...
class ProxyManager:
    ...
    - Continuous health checking (every 5 minutes)
    - Persistent proxy statistics
    - Fallback to direct connections when needed
    - Automatic recovery of previously failed proxies
    """
    ...
    def __init__(self, proxy_file="proxies.txt", connect_timeout=5):
        ...
        self.refresh_interval = 300  # Check proxies every 5 minutes (300 seconds)
